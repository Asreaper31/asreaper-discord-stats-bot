...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    ${message.guild.name} Adlı, Sunucudaki Toplam *\`Chat/Ses\` Verileri
    **===============**
    ...
    **• Mesaj Verileri: (\`Toplam ${Number(messageGuildData ? messageGuildData.topStat : 0).toLocaleString()} mesaj\`)**
    ${messageUsers.length > 0 ? messageUsers : "Veri Bulunmuyor."}
    
    **• Mesaj Kanal Verileri (Toplam.):**
